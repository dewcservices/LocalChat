...
import { getChatHistories, deleteChatHistories, deleteChatHistory, rename as renameChat } from "../utils/ChatHistory";
      ...
      <div class="sidebarContainer">
        ...
        <For each={chats()}>{(chat) =>
          ...
          {/* TODO make the latest message date update for each new message sent */}
            <Show
            // truncation works and the relative positioning of elements is consistent
