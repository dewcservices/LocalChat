...
function Summarize() {
  ...
  const loadModel = async (event) => {
    ...
    generator = await pipeline('summarization', event.target.value, { device: chatContext.processor() });
      ...
      <div class={styles.inputContainer}>
        ...
        <div class={styles.controlsContainer}>
          ...
          <div class={styles.controlsRight}>
            ...
            <input type="file" id="folderInput" class={styles.hidden} webkitdirectory multiple onChange={addModel} />
            <button 
              id="sendButton" 
